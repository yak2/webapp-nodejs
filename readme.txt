...
# docker run -itd -p 3000:3000 hello-docker 
...
master : docker swarm init --addvertise-addr <master-host-ip>
worker : docker service create --name="Hello-World" hello-world --mode=global
